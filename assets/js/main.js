...
function _tplHeader() {
      ...
      <div class="header__inner">
        ...
        <div class="header__actions">
          <div class="header__phone">
            <a href="tel:+78001234567" class="header__phone-number">+7 (800) 123-45-67</a>
            <span class="header__phone-label">Бесплатно по России</span>
          </div>
  ...
  <div class="mobile-menu" id="mobileMenu" role="dialog" aria-label="Мобильное меню" aria-modal="true">
    ...
    <div class="mobile-menu__footer">
      <a href="tel:+78001234567" class="mobile-menu__phone">+7 (800) 123-45-67</a>
      <p class="text-sm text-muted">Бесплатно, пн–пт 9:00–18:00</p>
  ...
  <footer class="footer" role="contentinfo">
    <div class="container">
        ...
        <div class="footer__brand">
          ...
          <div class="footer__contacts">
            <div class="footer__contact-item">
              ...
              <a href="tel:+78001234567" style="color:inherit;cursor:pointer;transition:color var(--transition-fast);" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='inherit'">+7 (800) 123-45-67</a>
            </div>
            <div class="footer__contact-item">
              ...
              <a href="mailto:info@rels-komplekt.ru" style="color:inherit;cursor:pointer;transition:color var(--transition-fast);" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='inherit'">info@rels-komplekt.ru</a>
            </div>
            <div class="footer__contact-item">
      ...
      <div class="footer__bottom">
        ...
        <p class="footer__copy">ИНН: 7700000000 · ОГРН: 1090000000000</p>
      </div>
    </div>
  </footer>`;
}
